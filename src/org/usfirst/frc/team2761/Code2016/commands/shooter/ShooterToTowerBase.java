 ...
 *
 */
public class ShooterToTowerBase extends Command {

	Shooter shooter;
	
    public ShooterToTowerBase() {
...
//    	shooter.adjustAngle(-0.25);
    	System.out.println("Tower Base Start     -     " + shooter.getPosition());
    	shooter.adjustAngle(-700);
    }
