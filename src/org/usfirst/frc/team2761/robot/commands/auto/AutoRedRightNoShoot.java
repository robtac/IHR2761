 ...
 *
 */
public class AutoRedRightNoShoot extends CommandGroup {

    public AutoRedRightNoShoot() {
        // Add Commands here:
        ...
        // arm.
    	Logger.println("Starting auto red right no shoot");
    	...
    	addSequential(new ForwardEncoderPID(61));
    	addSequential(new ZeroEncoders());
    	addSequential(new ZeroGyro());
    	addSequential(new Wait(0.01));
