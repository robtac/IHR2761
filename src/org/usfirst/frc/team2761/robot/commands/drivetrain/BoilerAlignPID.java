 ...
 *
 */
public class BoilerAlignPID extends Command {
...
//			pidController.setSetpoint(10);
			...
			Logger.println("BoilerAlignPID init");
    	}
    }
...
//    		return true;
    ...
    protected void end() {
    	...
    	Logger.println("Stopping BoilerAlignPID");
    }
